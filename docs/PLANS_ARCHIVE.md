# finfetch — PLANS ARCHIVE

This file retains historical planning detail that was moved out of
`docs/PLANS.md` to keep it short and current.
...
## CLI Scope & Commands (Original MVP)
...
## Export Folder Convention (Draft)
